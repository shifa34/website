...
<div class ="container">
        ...
        <div class="col-md-4">
            <div class="row">
                <form action="proses_pengembalian.php?aksi=edit" method = "post">                          
                    <div class="mb-3"> 
                    ...
                    <div class="mb-3"> 
                        ...
                        <input type="text" class="form-control" name="tgl_kembali" value="<?= $data['tgl_kembali'] ?>" readonly>  
                    </div>
                    <div class="mb-3"> 
