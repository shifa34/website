...
?>
    <div class = "container">
        ...
        <table class="table table-bordered">
            ...
            <?php
                    include "koneksi.php";
                    $peminjaman=mysqli_query($conn,"SELECT * FROM peminjaman INNER JOIN anggota
                    ON peminjaman.id_anggota=anggota.nim INNER JOIN buku on peminjaman.id_buku=buku.id_buku"); 
