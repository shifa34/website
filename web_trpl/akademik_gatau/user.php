...
?>
            <tr>
                ...
                <td><?= $data['level']?></td>                
                <td>
                        <a href="proses_user.php?aksi=delete&id_hapus=<?= $data['id'] ?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');" class="btn btn-danger">
						<span data-feather="trash-2" class="align-text-bottom"></span>Hapus</a>
                        <a href="index.php?p=user&page=edit&id_edit=<?= $data['id'] ?>" class=" btn btn-warning">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    ...
                    <a href="index.php?p=user">
                        <input type="button" name="kembali" value="Kembali" class="btn btn-secondary">
                    </a>
                </div>
            </div>
        </form>
