                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="/bahan-backend/create" class="btn btn-sm btn-primary">Tambah</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="text-center" href="/bahan-backend/{{$bahan->id}}/edit">
                                            <button type="button" class="btn btn-success">Edit</button>
                                        </a>
                                        <form action="bahan-backend/{{$bahan->id}}" method="post">
                                            @method('DELETE')
                                            @csrf
