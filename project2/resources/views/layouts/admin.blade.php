...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Kounyah<sup></sup></div>
        </a>
        ...
        <li class="nav-item {{ Nav::isRoute('basic.index') }}">
            <a class="nav-link" href="/minuman-backend">
                <i class="fas fa-fw fa-plus"></i>
                <span>{{ __('Minuman') }}</span>
            </a>
        </li>

        {{-- <!-- Nav Item -->
        <li class="nav-item {{ Nav::isRoute('basic.index') }}">
            <a class="nav-link" href="/bahan-backend">
                <i class="fas fa-fw fa-plus"></i>
                <span>{{ __('Bahan') }}</span>
            </a>
        </li> --}}
        ...
        <!-- Nav Item -->
        <li class="nav-item {{ Nav::isRoute('basic.index') }}">
            <a class="nav-link" href="/posisi-backend">
                <i class="fas fa-fw fa-plus"></i>
                <span>{{ __('Posisi') }}</span>
            </a>
        </li>
