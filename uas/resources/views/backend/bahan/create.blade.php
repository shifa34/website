          ...
          <div class="col-xl-12 mb-5 mb-xl-0">
              <div class="card shadow">
                  <div class="card-header border-0">
                    ...
                    <br><br>
                    <form method="post" action="/bahan-backend">
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="stok" id="example-text-input">
                      </div>

                      <div class="form-group">
                        <label for="exampleFormControlTextarea1">Harga</label>
                        <input class="form-control" type="number" name="harga" id="example-text-input">
                      </div>
